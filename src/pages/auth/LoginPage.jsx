...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // No need to navigate here as the callback will handle it
    } catch (err) {
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-navy-900 text-skyblue-300">New to HopeLink?</span>
                </div>
              </div>
              ...
              <div className="mt-6">
                <Link
                  to="/signup"
                  className="w-full flex justify-center py-2 px-4 border border-skyblue-600 rounded-lg text-sm font-medium text-skyblue-400 bg-navy-800 hover:bg-navy-700 transition-colors"
                >
                  Create an account
                </Link>
              </div>
